...
<!--注册-->
<div class="wrap">
 <form  action="l_add" method="post">
	<div class="tdbModule loginPage">
		<div class="registerTitle">用户登录</div>
		<div class="registerCont">
			<ul>
				<li>
					<span class="dis">登录账号：</span><input class="input" type="text" onblur="userNameJy()" name="j_username" id="userName" maxlength="24" tabindex="1" autocomplete="off">
				</li>
                ...
                <li>
                    <span class="dis">验证码：</span><input type="text" name="code"/><img src="captcha/1"  alt="验证码" title="刷新图片" width="100" height="40" id="c2c98f0de5a04167a9e427d883690ff6" border="0"> <span> <a id="change" href="javascript:;" code_src=""> 换一张</a></span>
                </li>
				<li class="btn"> 
					<input type="submit" class="radius1" value="立即登录" >
				</li>
			</ul>
		</div>
	</div>
