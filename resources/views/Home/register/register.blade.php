    ...
    <div class="registerCont">
        <form action="r_add" method="post">
            <ul>
                ...
                <li> <span class="dis">My email:</span>
                <input type="text"  class="input input1 _yanzhengma" name="email" style="width: 250px"  maxlength="50" tabindex="1"><a
                            href="send"><span>发送验证码</span></a>
                </li>
                <li class="telNumber"><span class="dis">邮箱验证码:</span>
                <input id="phonVerify" type="text" class="input input1  _phonVerify" data-_id="phonVerify" tabindex="1">
                <span class="info" id="phonVerifys" data-info="请输入手机验证码">请输入验证码</span></li>
                ...
                <li class="btn"><input type="submit" value="下一步"/></li>
            </ul>
        </form>
    </div>
  </div>
