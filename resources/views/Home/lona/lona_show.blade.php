  ...
  <div class="header min-width">
    <div class="container">
      ...
      <ul class="top-nav fn-clear">
        ...
        <li class="top-nav-safe"> <a href="core.html">我的账户</a> </li>
        <li> <a href="desc.html">关于我们</a> </li>
      </ul>
    </div>
  </div>
</header>
...
<div class="wrap">
  <div class="tdbModule register">
    ...
    <div class="registerLc3">
        <p class="p1">填写贷款信息</p>
        <p class="p3">申请贷款已提交</p>
    </div>
    <div class="registerCont">
      <ul>
        <li class="scses">申请贷款已提交，详情请进入我的账户请到我得账户中查看进度！</li>
        <li class="rz"><a href="core" class="btn">进入我的账户</a><a href="#" class="blue"></a></li>
      </ul>
    </div>
  </div>
</div>
